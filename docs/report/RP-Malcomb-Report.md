...
Bring in FEWSNET data (polygon***) and UNEP/GRID data (raster)
FIELD CALCULATOR: quintile (assign scores 0-5) and weight FEWSNET data
RASTER CALCULATOR: quintile (assign scores 0-5) and weight UNEP/GRID data
