...
my_ta_resilience = read_sf(here("data", "derived", "public", "ta_resilience_newnew.shp")) %>%
  # make geometries valid
  st_make_valid() 

my_vulnerability_grid = read_sf(here("data", "derived", "public", "georeferencing_vulnerability_grid.shp")) %>%
  # make geometries valid
  st_make_valid() 
```
